...
if [[ ":$FPATH:" != *":/Users/opo/.zsh/completions:"* ]]; then export FPATH="/Users/opo/.zsh/completions:$FPATH"; fi
...
# pnpm
export PNPM_HOME="/Users/opo/Library/pnpm"
case ":$PATH:" in
  *":$PNPM_HOME:"*) ;;
...
case ":$PATH:" in
  *":/Users/opo/bin:"*) ;;
  *) export PATH="$PATH:/Users/opo/bin" ;;
esac
# bit end
